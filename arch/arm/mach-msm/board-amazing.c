...
#if defined(CONFIG_SENSORS_BMA222E) || defined(CONFIG_PROXIMITY_SENSOR)
...
#if defined(_CONFIG_MACH_JENA) || defined(_CONFIG_MACH_TREBON) || defined(_CONFIG_MACH_AMAZING)
...
/** vreg_usb_3.3 is always on. So we do not control it.
   *  And it is initialized by boot. **/
...
static struct msm_gpio sdc1_cfg_data[] = {
	{GPIO_CFG(51, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
								"sdc1_dat_3"},
	{GPIO_CFG(52, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
								"sdc1_dat_2"},
	{GPIO_CFG(53, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
								"sdc1_dat_1"},
	{GPIO_CFG(54, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
								"sdc1_dat_0"},
	{GPIO_CFG(55, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
								"sdc1_cmd"},
	{GPIO_CFG(56, 1, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_4MA),
								"sdc1_clk"},
};
...
{
	int ret = -EPERM;
	char panel[2][21] = {"lcdc_amazing_smd_hvga", "lcdc_amazing_auo_hvga"};
	int lcd_id = -1;
	...
	printk(KERN_INFO "LCD %s selected\n", panel[lcd_id - 1]);
		...
		if (!strncmp(name, "lcdc_s6d16a0x_hvga"), 19)
			...
			ret = -ENODEV;
#elif defined(CONFIG_FB_MSM_LCDC_AMAZING_HVGA)
...
static void __init msm_device_i2c_init(void)
{
	...
	gpio_tlmm_config(GPIO_CFG(GPIO_TSP_SDA, 0, GPIO_CFG_INPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(GPIO_TSP_SCL, 0, GPIO_CFG_INPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
	gpio_tlmm_config(GPIO_CFG(GPIO_TOUCH_IRQ, 0, GPIO_CFG_INPUT,
			GPIO_CFG_NO_PULL, GPIO_CFG_2MA), GPIO_CFG_ENABLE);
